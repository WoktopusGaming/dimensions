...
public class MoukiBiomeLeaveDecorator extends LeaveVineDecorator {
	public static final MoukiBiomeLeaveDecorator INSTANCE = new MoukiBiomeLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("mouki_biome_tree_leave_decorator", tdt);
	}

	public MoukiBiomeLeaveDecorator() {
		super(0.25f);
	}
