...
public class MoukiBiomeBiome {
	public static final Climate.ParameterPoint PARAMETER_POINT = new Climate.ParameterPoint(Climate.Parameter.span(-0.166666666667f, 0.166666666667f),
			...
			Climate.Parameter.span(-0.160185409432f, 0.173147923902f), 0);
	...
	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(-3355444).waterColor(4159204).waterFogColor(329011)
				.skyColor(-3355444).foliageColorOverride(10387789).grassColorOverride(-10027162).build();
				...
				PlacementUtils.register("dimensions:tree_mouki_biome",
						FeatureUtils.register("dimensions:tree_mouki_biome", Feature.TREE,
								new TreeConfiguration.TreeConfigurationBuilder(
										BlockStateProvider.simple(DimensionsModBlocks.BLUEWOOD_LOG.get().defaultBlockState()),
										new MegaJungleTrunkPlacer(8, 2, 19),
										BlockStateProvider.simple(DimensionsModBlocks.BLUEWOOD_LEAVES.get().defaultBlockState()),
										new MegaJungleFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 2), new TwoLayersFeatureSize(1, 1, 2))
										.decorators(ImmutableList.of(MoukiBiomeLeaveDecorator.INSTANCE, MoukiBiomeTrunkDecorator.INSTANCE,
												MoukiBiomeFruitDecorator.INSTANCE))
										.build()),
						List.of(CountPlacement.of(3), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(0),
								PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING),
								BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("dimensions:grass_mouki_biome", VegetationFeatures.PATCH_GRASS,
						List.of(NoiseThresholdCountPlacement.of(-0.8D, 5, 4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
								BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("dimensions:flower_mouki_biome", VegetationFeatures.FLOWER_DEFAULT, List.of(CountPlacement.of(4),
