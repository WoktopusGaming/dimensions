...
public class HeartofFirstDimensionItem extends Item {
	public HeartofFirstDimensionItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("A heart of First Dimension, used for portal frames for the Teleport Block."));
	}
}
